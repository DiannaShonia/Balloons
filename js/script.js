balloonColor = ["yellow", "red", "blue" , "violet", "green"];
...
function createBalloon() {
    ...
    let rand = Math.floor(Math.random() * balloonColor.length);
    div.className = 'balloon balloon-' +balloonColor[rand];
...
function animateBalloon(elem) {
    ...
    function frame() {
        if (position >= (windowHeight + 200) && (document.querySelector('[data-number="'+elem.dataset.number+'"]')!== null )) {
